...
- A component is used in all phases but its operational level {term}`REQUIREMENT`s may change. In this case, no special treatment is required for this component. The definition of operation or failed state depends on the success criteria.
